...
- O plano DEVE ter exatamente 7 dias (MONDAY a SUNDAY). Dias sem treino = `isRest: true`, `exercises: []`, `estimatedTimeInSeconds: 0`. Chame a tool `createWorkoutPlan` para criar o plano de treino.
